              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-8">
                ...
                >
                  ...
                  <div className="text-2xl font-black text-white">
                    +{countData ? countData.count.toLocaleString() : "128"}
                  </div>
                ...
                >
                  ...
                  <div className="text-2xl font-black text-white">
                    {dynamicProposals ? dynamicProposals.length : "3"}
                  </div>
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative bg-slate-50 border border-slate-200 rounded-3xl p-8 shadow-xl shadow-slate-200/50">
                <div className="flex items-center justify-between mb-8">
                  <div className="font-bold text-xl text-slate-900 flex items-center gap-2">
                    <div className="w-2 h-6 bg-primary rounded-full" />
                    Actividad Reciente
                  </div>
                  <div className="px-3 py-1 bg-primary/10 text-primary rounded-full text-xs font-bold uppercase tracking-widest">En Tiempo Real</div>
                </div>
                <div className="space-y-6">
                  {activities?.slice(0, 2).map((activity) => (
                    <div key={activity.id} className="flex gap-4 p-4 rounded-2xl bg-white hover:bg-slate-100 transition-colors border border-slate-100 shadow-sm">
                      ...
                      <div>
                        ...
                        <div className="font-bold text-slate-900 line-clamp-1">{activity.title}</div>
                        <div className="text-xs text-slate-500 line-clamp-1">{activity.description}</div>
                      </div>
                    </div>
                  ))}
                  <Button variant="outline" className="w-full border-slate-200 text-slate-600 hover:bg-slate-50 hover:text-primary transition-all" onClick={() => document.getElementById("actividades")?.scrollIntoView({behavior: 'smooth'})}>
